...
const Footer5 = () => {
    return (
        <div style={BannerImg} className="text-gray-400">
            <div className="container">
                <div data-aos="zoom-in" className="grid md:grid-cols-3 pb-44 pt-5">
                    {/* company details */}
                    <div className="py-8 px-4">
                        <h1 className="sm:text-3xl text-white text-xl font-bold sm:text-left text-justify mb-3 flex items-center gap-3">
