          ...
          <div className="flex flex-wrap">
            <form className="mb-12 w-full shrink-0 grow-0 basis-auto md:px-3 lg:mb-0 lg:w-5/12 lg:px-6">
              <div className="mb-3 w-full">
                <label
                  className="block font-medium mb-[2px] text-gray-800 dark:text-yellow-300"
              ...
              <button
                ...
                type="submit"
                className="mb-6 inline-block w-full rounded bg-yellow-400 px-6 py-2.5 font-medium uppercase leading-normal text-gray-800 hover:shadow-md hover:bg-yellow-500 dark:bg-yellow-600 dark:hover:bg-yellow-400"
              >
                ...
                <div className="mb-8 w-full shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:px-6">
                  <div className="flex items-start">
                    <div className="shrink-0">
                      <div className="inline-block rounded-md bg-yellow-400-100 p-4 text-yellow-5 bg-yellow-400 dark:text-yellow-300">
                        <svg
