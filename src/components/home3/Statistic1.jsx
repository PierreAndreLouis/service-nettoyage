...
export default function Statistic1() {
  return (
    <div>
      <section className="flex flex-col  bg-white dark:bg-gray-900 py-10 pt-0">
        ...
        <div
          ...
          <div
            className="flex flex-col justify-center items-center w-full   bg-yellow-100 dark:bg-gray-800 px-4 h-[126px] lg:h-[192px] rounded-lg justify-self-center">
            <div className="flex flex-row justify-center items-center">
              <svg className="w-[35px] h-[35px] md:w-[50px] md:h-[50px]" viewBox="0 0 50 50" fill="none"
                ...
                <path
                  ...
                  stroke="orange" strokeWidth="3.473" strokeLinecap="round" strokeLinejoin="round"></path>
                <path
              ...
              <p className="font-bold text-3xl sm:text-4xl lg:text-5xl text-slate-800 leading-9 text-primary ml-2 dark:text-gray-100">
                500+
              </p>
            </div>
              ...
              <svg className="w-[35px] h-[35px] md:w-[50px] md:h-[50px]" viewBox="0 0 51 50" fill="none"
                ...
                <g clipPath="url(#a)">
                  <path
                    ...
                    stroke="orange" strokeWidth="4.341" strokeLinecap="round" strokeLinejoin="round"></path>
                </g>
                <defs>
                  <clipPath id="a">
          ...
          <div
            ...
            <div className="flex flex-row justify-center items-center">
              <svg className="w-[35px] h-[35px] md:w-[50px] md:h-[50px]" viewBox="0 0 50 50" fill="none"
                xmlns="http://www.w3.org/2000/svg">
                <g clipPath="url(#a)" stroke="orange" strokeWidth="3.473" strokeLinecap="round" strokeLinejoin="round">
                  <path
          ...
          <div
            ...
            <div className="flex flex-row justify-center items-center">
              <svg className="w-[35px] h-[35px] md:w-[50px] md:h-[50px]" viewBox="0 0 51 50" fill="none"
                xmlns="http://www.w3.org/2000/svg">
                <path d="M45.571 12.006 27.046 30.531l-7.719-7.718L5.434 36.706" stroke="orange" strokeWidth="4.341"
                  strokeLinecap="round" strokeLinejoin="round"></path>
                <path d="M45.569 24.356v-12.35h-12.35" stroke="orange" strokeWidth="4.341" strokeLinecap="round"
