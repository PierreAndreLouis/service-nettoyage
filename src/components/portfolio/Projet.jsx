...
function Projet() {
  return (
    <div className="min-h-screen w-full">
      <div className="bg-yellow-50 dark:bg-gray-900 px-4 md:px-8 py-20 pb-52">
        <div id="features" className="mx-auto max-w-6xl ">
          <p className="text-center text-xl font-semibold leading-7 text-primary-500 dark:text-yellow-500 ">
            ...
            <div className="bg-white/70 shadow-lg dark:bg-slate-800 rounded-xl p-4">
              ...
              <div>
                ...
                <div className="flex justify-center ">
                  <button className="py-1 px-4 mx-auto max-w-[10rem] w-full mt-4-- rounded-lg text-center bg-yellow-500 text-white">
                    Visiter
                  </button>
                </div>
              </div>
